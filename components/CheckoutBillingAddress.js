...
class CheckoutBillingAddress extends ValidationComponent {
  ...
  setDate(newDate) {
    this.setState({ deliveryDate: newDate, datePick: "true" });
  }
        ...
        >
          ...
          >
            ...
            {this.isFieldInError("state_division") && (
              <Text style={{ color: "red" }}>Please select state/division</Text>
            )}
            ...
            {this.isFieldInError("deliverytime") && (
              <Text style={{ color: "red" }}>Please select delivery time</Text>
            )}
            ...
            {this.isFieldInError("datePick") && (
              <Text style={{ color: "red" }}>Please select delivery date</Text>
            )}
